...
class PostListEndpoint(Resource):
    ...
    def get(self): #HTTP GET
        ...
        try:
            ...
            return Response(json.dumps("error: Limit parameter is invalid"), mimetype="application/json", status=400)
        if limit > 50:
...
class PostDetailEndpoint(Resource):
    ...
    def delete(self, id):
        ...
        return Response(json.dumps({"message": "Successful deletion"}), mimetype="application/json", status=200)
